/* Akcja Klimatyzacja — landing page interactions */
(function () {
  'use strict';
  ...
  var CONTACT_EMAIL = 'kontakt@akcjaklimatyzacja.com';
  ...
  var sections = ['uslugi', 'wycena', 'proces', 'realizacje', 'opinie', 'faq', 'kontakt']
